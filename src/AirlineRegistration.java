...
public class AirlineRegistration {public static void main(String[] args) {
	...
	String gender = JOptionPane.showInputDialog("Are you male or female? (for security purposes)");
	JOptionPane.showMessageDialog(null, lastname +" / " + name + " ( " + birthday + ", " + gender + ")"+" \nTraveling to: " + destination);
}
}
