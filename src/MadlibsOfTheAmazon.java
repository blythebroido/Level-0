...
public class MadlibsOfTheAmazon {
	public static void main(String[] args) {
		...
		JOptionPane
				.showMessageDialog(
						null,
						"If you find yourself having to cross a piranha-infested river, here's to do it...");
		// Get the user to enter an adjective
		String adjective = JOptionPane
				.showInputDialog("Please enter adjective.");
		// Get the user to enter a type of liquid
		String liquid = JOptionPane
				.showInputDialog("Please enter a type of liquid.");
		// Get the user to enter a body part
		String bodypart = JOptionPane
				.showInputDialog("Please enter a body part.");
